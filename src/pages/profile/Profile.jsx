      ...
      <main>
        <div className="user">
          ...
          <div className="box3">
            <h2>About me</h2>
            <p>
              I am a passionate and dedicated programmer with a strong
              background in computer science and software development. With a
              keen eye for detail and a love for problem-solving, I thrive in
              the fast-paced world of programming. My expertise lies in coding
              languages such as Java, Python, and C++, and I am constantly
              expanding my skills to stay up-to-date with the latest
        ...
        <div className="test">
          <div className="stage">
            <h6>How many hours a day can you devote to your future career?</h6>
            <FormControl fullWidth>
              ...
              <Select
                ...
                label="Hours"
              >
                <MenuItem value={"2-4 hours a day"}>2-4 hours </MenuItem>
                <MenuItem value={20}>4-8 hours</MenuItem>
                <MenuItem value={30}>4-6 hours</MenuItem>
              </Select>
            </FormControl>
          </div>
          <div className="stage">
            <h6>
              Do you consider yourself creative or do you think that you do
              everything with precision down to the smallest detail?
            </h6>
            <FormControl fullWidth>
              <InputLabel id="demo-simple-select-label">Prefer</InputLabel>
              <Select
                labelId="demo-simple-select-label"
                id="demo-simple-select"
                label="Prefer"
              >
                <MenuItem value={10}>Creative</MenuItem>
                <MenuItem value={20}>Smallest details</MenuItem>
                <MenuItem value={30}>I don't know for sure</MenuItem>
              </Select>
            </FormControl>
          </div>
          <div className="stage">
            <h6>
              Do you want to work with a computer or a phone in the future?
            </h6>
            <FormControl fullWidth>
          ...
          <div className="stage">
            <h6>
              How much time is convenient for you to study your future pro
              fession career?
            </h6>
            <FormControl fullWidth>
              ...
              <Select
                ...
                label="Years"
              >
                <MenuItem value={10}>1-3 years</MenuItem>
                <MenuItem value={20}>4-5 years</MenuItem>
